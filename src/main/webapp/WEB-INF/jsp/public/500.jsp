...
<section class="page-404 minWP text-c">
  ...
  <p class="error-description">抱歉，您访问的页面出错了~</p>
  <p class="error-info">您可以：<a href="javascript:;" onclick="history.go(-1)" class="c-primary">&lt; 返回上一页</a><span class="ml-20">|</span><a href="javascript:toHome();" class="c-primary ml-20">去首页 &gt;</a></p>
</section>
</body>
</html>